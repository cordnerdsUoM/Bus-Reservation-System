...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Remove Route</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action = "routeDelete.php" method = "post">
                                        <div class="form-group">
                                            <label>Route No</label>
                                            <input class="form-control"  placeholder="Enter route no" type =" text" name="id" onkeypress="return mask_Number(this,event);"/>
                        ...
                        <?php
                            ...
                            echo " <div class='row'>
                                  <div class='col-lg-6'>
                                    <form role='form' action ='routeDelete.php' method='get'>    
                                        <div class='form-group'>
                                            <label>Route No</label>
                                            <input  class='form-control' placeholder='Enter Route No' type ='text' name='id' value = '$id'><p>
                                        </div>       
                                        
                                        <div class='form-group'>
                                            <label>Route Name</label>
                                            <input class='form-control' placeholder='Enter text' type='text' name ='routeName' value = '$routeName'>
                                        </div>
                                        
                                        <div class='form-group'>
                                            <label>Roads</label>
                                            <input class='form-control' placeholder='Enter text' type='text' name ='roads' value = '$roads'>
                                            
                                        </div>                  
                                        
                                        
                                        <button type='submit' class='btn btn-default'>Remove Record</button>   
                                        </form> 
                       ...
                       // }
						...
						$sql = "DELETE FROM route WHERE Route_No ='$id'";
