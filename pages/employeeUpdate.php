                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action = "employeeUpdate.php" method = "post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control"  placeholder="Enter Employee ID" type =" text" name="id">
						...
						<?php
							...
							if($id){
								...
								echo " <div class='row'>
								  <div class='col-lg-6'>
									<form role='form' action ='employeeUpdate.php' method='get'>	
										<div class='form-group'>
											<label>ID</label>
								...
								$NIC_No = filter_input(INPUT_GET, 'NIC');
								$license_No = filter_input(INPUT_GET, 'licenseNo');
								$job_Type = filter_input(INPUT_GET, 'jobType');
								$contact_No = filter_input(INPUT_GET, 'contact_no');


								if ($id && $firstName && $lastName && $NIC_No && $license_No && $job_Type && $contact_No) {

									$sql2 = "UPDATE employee SET Employee_ID = '$id',Contact_No = '$contact_No',NIC = '$NIC_No',License_No = '$license_No',Job_Type = '$job_Type' WHERE Employee_ID = '$id'";
									$sql3 = "UPDATE employee_name SET Employee_ID = '$id' ,First_Name = '$firstName' ,Last_Name = '$lastName' WHERE Employee_ID = '$id'";
