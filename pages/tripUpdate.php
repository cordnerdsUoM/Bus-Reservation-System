...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Turn</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action = "tripUpdate.php" method = "post">
                                        <div class="form-group">
                                            <label>Turn No</label>
                                            <input class="form-control"  placeholder="Enter trip no" type =" text" name="id" onkeypress="return mask_Number(this,event);"/>
                        ...
                        <?php
                            ...
                            if ($result1 === false) {
                                echo "<script type='text/JavaScript'>alert('Please check the turn number and route number');</script>";
                            }
                            ...
                            echo " <div class='row'>
                                  <div class='col-lg-6'>
                                    <form role='form' action ='tripUpdate.php' method='get'>    
                                        <div class='form-group'>
                                            <label>Turn No</label>
                                            <input  class='form-control' placeholder='Enter Turn No' type ='text' name='id' value = '$id' onkeypress='return mask_Number(this,event);'/><p>
                                        </div>       
                                        
                                        <div class='form-group'>
                                            <label>Departure Station</label>
                                            <input class='form-control' placeholder='Enter text' type='text' name ='departureSta' value = '$departureSta' onkeypress='return mask_Letter(this,event);'/>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <input class='form-control' placeholder='Enter text' type='text' name ='arrivalSta' value = '$arrivalSta' onkeypress='return mask_Letter(this,event);'/>
                                        </div>
                                        ...
                                        <div class='form-group'>
                                            <label>Route No</label>
                                            <input class='form-control' placeholder='Enter text' type='text' name ='routeNo' value = '$routeNo' onkeypress='return mask_Number(this,event);'/>
                                        </div>
							...
							$departureSta = filter_input(INPUT_GET, 'departureSta');	
							$departureTime = filter_input(INPUT_GET, 'departureTime');
							$arrivalSta = filter_input(INPUT_GET, 'arrivalSta');
							$arrivalTime = filter_input(INPUT_GET, 'arrivalTime');
							$routeNo = filter_input(INPUT_GET, 'routeNo');

							if ($id && $departureSta && $departureTime && $arrivalSta && $arrivalTime && $routeNo) {

								$sql2 = "UPDATE turn SET Turn_No = '$id',Departure_station = '$departureSta',Departure_Time = '$departureTime',Arrival_Station = '$arrivalSta',Arrival_Time = '$arrivalTime' , Route_No = '$routeNo' WHERE Turn_No = '$id'";
								//$sql = "UPDATE turn SET Turn_No = '$id',Departure_station = '$departureSta', Departure_Time = '$departureTime', Arrival_Station = '$arrivalSta' , Arrival_Time = '$arrivalTime' ERE Route_No = '$id'";	
