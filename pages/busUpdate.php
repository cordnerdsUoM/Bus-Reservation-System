    ...
    <div id="wrapper">
       ...
       <!-- Navigation -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="tripUpdate.html">Update Trip</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Bus</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
							...
							if($bus_id){
								if(!($bus_id && $bus_model)){
									...
									echo " <form role='form' action = 'busUpdate.php' method = 'GET'>
                                        <div class='form-group'>
                                            <label>Bus No</label>
									...
									$bus_id = filter_input(INPUT_GET, 'bus_no');
									$bus_model = filter_input(INPUT_GET, 'model');
									$smoke_area = filter_input(INPUT_GET, 'isSmokeArea');
       
        

									if ($bus_id && $bus_model) {

										$sql = "UPDATE bus SET Bus_No = '$bus_id' , Bus_Model = '$bus_model', Smoke_Area='$smoke_area' WHERE Bus_No = '$bus_id'";
