                                ...
                                <div class="col-lg-12">
                                    ...
                                    <?php
										...
										echo "<div class='table-responsive'>
										 ...
										 $smokeAreaAvailability = '';
										 
										if($result1 -> num_rows > 0 ){
											while ($row1 = $result1 -> fetch_assoc() ) {
											
												if($row1['Smoke_Area'] == 1){
													$smokeAreaAvailability = 'Available';
												}
												
												else{
													$smokeAreaAvailability = 'Not Available';
												}
												
                 								echo "<tr><td>".$row1['Bus_No']."</td><td> ".$row1['Bus_Model']."</td><td> ".$smokeAreaAvailability."</tr></p>";
											}
											echo "</table>";
										}
										else {
